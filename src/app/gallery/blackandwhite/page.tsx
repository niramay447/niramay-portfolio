...
export default function BlackAndWhitePhotography() {
  // Get black and white photography images
  const bwImages = getImagesByCategory('blackandwhite');
      ...
      <section className="pt-32 pb-20 container-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl">
            Expressing mood, emotion, and contrast through the absence of color. 
            These monochromatic images focus on composition, texture, light, and shadow to convey their stories.
          </p>
        </motion.div>
