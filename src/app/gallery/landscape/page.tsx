...
export default function LandscapePhotography() {
  // Get landscape photography images
      ...
      <section className="pt-32 pb-20 container-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl">
            Exploring the majesty and tranquility of natural environments. These images 
            capture the grandeur of landscapes, from sweeping vistas to intimate natural details.
          </p>
        </motion.div>
