...
export default function PortraitPhotography() {
  // Get portrait photography images
      ...
      <section className="pt-32 pb-20 container-padding max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl">
            Capturing the essence and personality of individuals through thoughtful composition, 
            lighting, and emotional connection. Each portrait tells a unique human story.
          </p>
        </motion.div>
